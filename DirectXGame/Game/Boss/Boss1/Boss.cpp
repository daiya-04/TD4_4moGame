...
#include"Boss/Boss1/Behavior/AreaAttack/BossAreaAttack.h"
#include"Boss/Boss1/Behavior/WeaponRollAttack/BossWeaponRollAttack.h"
#pragma endregion
...
Boss::Boss(FollowCamera* camera)
{
	...
	//マネージャ生成
	dangerZoneManager_ = std::make_unique<DangerZoneManager>(DangerZoneType::Normal);
	bulletManager_ = std::make_unique<BossBulletManager>(BulletType::Normal);
